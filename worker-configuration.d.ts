/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bfba33b11204f122c1db9409e428398d)
...
declare namespace Cloudflare {
	...
	interface Env {
		LLM_PROVIDER: string;
		LLM_MAX_WORKERS: string;
		LOG_LLM_CONTENT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LLM_PROVIDER" | "LLM_MAX_WORKERS" | "LOG_LLM_CONTENT" | "OPENAI_API_KEY" | "OPENAI_MODEL_NAME" | "ARK_API_KEY" | "ARK_MODEL_NAME" | "GEMINI_API_KEY" | "GEMINI_MODEL_NAME">> {}
}
